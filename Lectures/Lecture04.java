...
////        List<Integer> list_1 = new ArrayList_from_scratch<>(Arrays.asList(one));
////        List<Integer> list_2 = new ArrayList_from_scratch<>(Arrays.asList(two));
...
//        List <Integer> out = new ArrayList_from_scratch<>();
