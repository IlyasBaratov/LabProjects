...
//        {cotton=shirt, light=tree, speed=tree, tree=violin}
        ...
        List<Integer> for_Couont = new ArrayList<>(Arrays.asList(a_2));
...
//        System.out.println(length_of_the_method);
        ...
        List <Integer> first_for_counCommon = new ArrayList<>(Arrays.asList(3, 7, 3, -1, 2, 3, 7, 2, 15, 15));
        List <Integer> second_for_countCommon = new ArrayList<>(Arrays.asList(-5, 15, 2, -1, 7, 15, 36));
