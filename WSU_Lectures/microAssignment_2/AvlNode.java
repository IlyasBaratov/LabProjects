package microAssignment_2;// Basic node stored in AVL trees
...
class AvlNode<T extends Comparable<T>>
{
    ...
    //As a good practice, we are going to keep using getter/setter functions instead of accessing the property directly
